...
// Hapus gambar
$query_gambar = "SELECT * FROM product WHERE id='$id'";
...
if(file_exists($imageUrl))
{
    ...
    {
        $sql= "UPDATE product SET nama='$nama', id_kategori='$id_kategori', harga='$harga', deskripsi='$deskripsi', foto='$image' WHERE id='$id'";
    } else {
        $sql= "UPDATE product SET nama='$nama', id_kategori='$id_kategori', harga='$harga', deskripsi='$deskripsi' WHERE id='$id'";
    }

    $res = mysqli_query($db, $sql);
    if($res)
    {
        header("Location: pages/admin-products.php?success=update");
    } else {
        echo $db->error;
    }
} else {
