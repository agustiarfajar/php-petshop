...
$db = dbConnect();
$sql = "SELECT product.*, product_category.nama as kategori 
...
if(isset($_POST["btnSave"]))
{
    ...
    $sql= "INSERT INTO product VALUES ('?', '$nama','$id_kategori','$harga','$deskripsi','$image')";
    $res = mysqli_query($db, $sql);
    if($res)
    {
                                    ...
                                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable"
                                        ...
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 class="modal-title" id="myModalLabel18">Add Products</h4>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <fieldset class="form-group mt-2">
                                                                    ...
                                                                    <select class="form-select" id="basicSelect" name="id_kategori" required>
                                                                        ...
                                                                        <?php 
                                                                            $sql_kat = "SELECT * FROM product_category";
                            ...
                            <table class="table table-striped" id="table1">
                                ...
                                <?php 
                                    if($res)
                                    {
                                        ...
                                        <td>
                                            <!-- EDIT -->
                                            <a href="admin-products-edit.php?id=<?php echo $row['id'] ?>" class="btn btn-info btn-sm"><i class="bi bi-pencil-square"></i> Edit</a>
                                            <!-- END EDIT -->
                                            <!-- DELETE -->
                                            <a href="../do-products-delete.php?id=<?php echo $row['id'] ?>" class="btn btn-danger btn-sm delete-confirm"><i class="bi bi-trash"></i> Danger</a>
                                            <!-- END DELETE -->
                                        </td>
                                        <!-- end kolom action -->
                                    </tr>
