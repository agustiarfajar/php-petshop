...
if(isset($_POST["btnSimpan"]))
{
    ...
    $sql_save = "INSERT INTO product_category(nama) VALUES('$nama')";
    $res_save = mysqli_query($db, $sql_save);

    if($res_save)
    {
        header('Location: admin-products-category.php?success=add');
    } else {
        echo $db->error;
    }
}
                                        ...
                                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable"
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h4 class="modal-title" id="myModalLabel18">Add Products Category</h4>
                            ...
                            <table class="table table-striped" id="table1">
                                ...
                                <?php 
                                    if($res)
                                    {
                                        ...
                                        <td>
                                            <!-- EDIT -->
                                            <a href="admin-products-category-edit.php?id=<?php echo $row['id'] ?>" class="btn btn-info"><i class="bi bi-pencil-square"></i> Edit</a>
                                            &emsp;
                                            <!-- END EDIT -->
                                            <!-- DELETE -->
                                            <a href="../do-products-category-delete.php?id=<?php echo $row['id'] ?>" class="btn btn-danger delete-confirm"><i class="bi bi-trash"></i> Danger</a>
                                            <!-- END DELETE -->
                                        </td>
                                        <!-- end kolom action -->
                                    </tr>
