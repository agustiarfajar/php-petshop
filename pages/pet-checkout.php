...
if(isset($_GET["id-pet"]))
{
    $id = $_GET["id-pet"];
    $data = getDetailPet($id);
}
?>
<?php header_section() ?>

<div class="container mt-4">
<form action="../do-user-order-pet.php" method="post">
    <h2>Detail Pemesanan</h2>
    <hr>
    <div class="mb-3 row">
        <label for="namapet" class="col-sm-2 col-form-label">Pet Name</label>
        <div class="col-sm-10">
            <input type="hidden" name="id_pet" value="<?php echo $data['id'] ?>">
            <input type="text" readonly class="form-control-plaintext" id="namapet" value="<?php echo $data['nama'] ?>">
        </div>
    </div>
    <div class="mb-3 row">
